...
\end{align}
and the ground plane intersect time $t_{intersect}$ was found by setting eq. \ref{eq:z_parabola} equal to the ground plane coordinate $z_{target}$ and finding the positive root. Le
