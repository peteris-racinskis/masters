...
\end{equation}
with $r^d_{intersect}, r^g_{intersect}$ being the demonstration and generated throw intersect positions respectively. Seeing as not every model would output a release signal that crossed the threshold (0.5) for trajectory, this error term was set to be infinite in cases when no throw was defined.
