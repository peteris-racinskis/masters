...
\begin{figure}[!hbt]
	\centering
	\fbox{\includegraphics[width=16cm]{../img/naivebc_missed.png}}
	\caption{Results -- comparison between model architectures, best performers in each class. The top row contains global comparison metrics, the middle row -- step-wise ones, whereas the bottom row shows the best attained throw accuracy.}
	\label{fig:naive_best}
\end{figure}


\begin{figure}[!hbt]
	\centering
	\fbox{\includegraphics[width=16cm]{../img/rnn-naive-global-stepwise-missed.png}}
	\caption{Results -- comparison between model architectures, best performers in each class. The top row contains global comparison metrics, the middle row -- step-wise ones, whereas the bottom row shows the best attained throw accuracy.}
...
\begin{figure}[!hbt]
	\centering
	\fbox{\includegraphics[width=16cm]{../img/rnn_missed.png}}
	\caption{Results -- comparison between model architectures, best performers in each class. The top row contains global comparison metrics, the middle row -- step-wise ones, whereas the bottom row shows the best attained throw accuracy.}
	\label{fig:rnn_best}
\end{figure}
