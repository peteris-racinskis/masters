...
To create the data, rigid body definitions in the operator software were created for all object to be tracked. These were then streamed on the local network, relayed over \emph{Robot Operating System} (ROS) topics corresponding to each rigid body using a pre-existing package and recorded into a bag file to be converted into a .csv data set.
