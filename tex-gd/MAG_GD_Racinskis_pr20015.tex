...
\begin{figure}[t!]
    ...
    \caption{Telpiski attēlotas autoregresora trajektorijas. Pa kreisi vizualizēts korpuss ar no gadījuma stāvokļiem ģenerētiem metieniem, pa labi -- trajektorija, kam piemēroti visi nepieciešami pārveidojumi, lai tā sakristu ar robota kontrolera koordinātu sistēmu.}
\end{figure}
