...
\begin{figure}[t!]
    \centering
    \includegraphics[height=8cm,page=1]{../img/6dof-kinematics.png}
    \caption{Tipiska 6-brīvības pakāpju industriālā robota shematisks attēls ar kinemātiskās ķēdes elementiem \cite{harib2012parallel}.}
\end{figure}
