...
Results show that models trained using the approaches presented in this thesis approximate the training and validation data sets well with respect to a number of metrics. Throws using model-generated trajectories were also successfully performed on a physical robot. \bigbreak
