...
Ievācot datus, lai izmantotu modeļa apmācībā, nereti tiek izmantota stāvokļu-darbību (\textit{state-action}) pāru forma --- $\lbrace (s_1, a_1), (s_1, a_1), ... \rbrace$. Stāvokļus tajā, protams, iespējams aizstāt ar novērojumiem situācijās, kad tiek izmantota nepilnīga informācija.
