...
\subsubsection{Dinamikas vispārināšana, atdarināšana}
...
Literatūras analīzē sniegts īss un nebūt ne pilnīgs --- vai vienlīdzīgi sadalīts --- līdz šim veiktās pētnieciskās darbības uzsvars. Jau izvēloties, par kurām tēmām rakstīts plašāk, par kurām --- mazāk detalizēti --- iespaidu uz darba saturu ir atstājusi motivējošās problēmas specifika. Tagad tikai nepieciešams pie tās atgriezties un novērtēt, kas no visa plašajā nozarē pētītā un izgudrotā attiecas uz darba ievadā aprakstīto uzdevumu --- mešanas kustību iestrādāšanu atkritumu vai citu objektu pārvietošanā.
...
\begin{enumerate}
    ...
    \item papildus optimizācija --- ja iespējams, ar nelielas un neoptimālas demonstrāciju kopas palīdzību apmācītu modeli var ievērojami uzlabot, papildus izmantojot stimu-lētās mācīšanās metodes, jo atalgojuma funkciju šoreiz ir samērā viegli definēt (bet grūti sasniegt).
\end{enumerate}

Šobrīd grūti paredzēt, kādi rezultāti tiks sasniegti eksperimentālajā darbībā, kuri pieņēmumi būs izrādījušies patiesi, kuri --- aplami. Taču pastāv iespēja, ka tieši tā arī izskatīsies risinājums, kas veidos maģistra darba praktisko daļu.
